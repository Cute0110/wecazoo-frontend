...
import { Home, UserIcon, WalletIcon, GiftIcon, LogOutIcon, Menu, ChevronLeft, ChevronRight, Headset, DiamondIcon, Cherry } from "lucide-react";
    ...
    <div className="fixed bottom-0 left-0 right-0 bg-[#1F1635] border-t border-gray-800 lg:hidden z-50">
      <div className="flex justify-around items-center py-3">
        <Sheet open={isOpen} onOpenChange={setIsOpen}>
          ...
          <SheetContent
            side="left"
            className="w-[280px] border-r border-gray-800 bg-[#1F1635] [&_button]:hidden"
          >
            <SidebarContent />
          </SheetContent>
        </Sheet>
