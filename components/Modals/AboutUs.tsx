...
const AboutUs = ({ isModalOpen, onModalClose, modalTitle }: any) => {
  ...
  return (
    <>
      <Modal title={modalTitle} centered open={isModalOpen} onOk={handleOk} onCancel={handleCancel} footer={null} width="40vw">
        <div className='h-[40vh] overflow-y-auto'>
          <div>
            <Image src="/images/hero.png" width={350} height={350} alt="hero" className='float-left rounded-md mr-4'></Image>
            <div>
              ...
              <div className='text-white text-lg text-center mt-[20px]'>
                Copyright ©2024 Wecazoo Team. ALL RIGHTS RESERVED
              </div>
            </div>
          </div>
        </div>
