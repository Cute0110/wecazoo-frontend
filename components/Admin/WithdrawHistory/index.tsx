  ...
  const onCreateTableData = (tempData: any, originalData: any, pageNum: any, pageCount: any) => {
    for (let i = 0; i < originalData.length; i++) {
      const temp = {
        ...
        amount: originalData[i].sentAmount.toFixed(2),
        address: originalData[i].address,
        asset: originalData[i].asset,
...
export default WithdrawtHistory;